	...
	.i:
		...
		.j:
			...
			.k:
				...
				movss xmm2, [rsi + 8 * r15]		;xmm2 = matrix2[r11][r12]

				sub r15, r8 ;Voy del ultimo al primer elemento de la columna
				movss xmm4, [rsi + 8 * r15]		;xmm2 = matrix2[r11][r12]

				sub r15, r8 ;Voy del ultimo al primer elemento de la columna
				movss xmm5, [rsi + 8 * r15]		;xmm2 = matrix2[r11][r12]

				sub r15, r8 ;Voy del ultimo al primer elemento de la columna
				movss xmm6, [rsi + 8 * r15]		;xmm2 = matrix2[r11][r12]
